# Source: https://github.com/YuxinWenRick/tree-ring-watermark/blob/main/inverse_stable_diffusion.py#L34
...
from methods.modified_stable_diffusion import ModifiedStableDiffusionPipeline
...
class InversableStableDiffusionPipeline(ModifiedStableDiffusionPipeline):
    ...
    def get_random_latents(self, latents=None, height=1024, width=1024, generator=None):
