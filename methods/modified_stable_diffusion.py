...
from diffusers.utils import logging, BaseOutput, deprecate, is_torch_xla_available
...
class ModifiedStableDiffusionPipeline(StableDiffusionXLPipeline):
    def __init__(self, 
        vae: AutoencoderKL,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if key is not None:
            ...
            watermarking_mask = get_watermarking_mask(init_latents, self.device)
            gt_patch = get_watermarking_pattern(self, self.device, key, init_latents.shape, init_latents.dtype)
        ...
        return ModifiedStableDiffusionPipelineOutput(images=image, init_latents=init_latents)
